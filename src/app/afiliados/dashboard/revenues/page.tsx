  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-black text-white">Histórico de receitas</h1>
          <p className="text-slate-500 text-sm mt-0.5">
            {total} operação{total !== 1 ? "ões" : ""} registrada{total !== 1 ? "s" : ""}
          </p>
        </div>
        <div className="text-right">
          <div className="text-xs text-slate-500 mb-0.5">Total (todas páginas)</div>
      ...
      <div className="bg-[#0d1117] border border-[#1e2a42] rounded-2xl overflow-hidden">
        <div className="px-6 py-4 border-b border-[#1e2a42] flex items-center justify-between">
        ...
        {loading ? (
          ...
          <>
            <div className="hidden md:grid grid-cols-[1fr_180px_120px_100px] gap-4 px-6 py-3 text-[10px] uppercase tracking-widest text-slate-600 border-b border-[#1e2a42]">
              <span>Jogador</span>
              <span>Data/Hora</span>
