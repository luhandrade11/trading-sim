...
export async function GET() {
  ...
  // 1 USD = rate.X  →
  //   EUR/USD = 1/rate.EUR   GBP/USD = 1/rate.GBP   AUD/USD = 1/rate.AUD
  //   NZD/USD = 1/rate.NZD   USD/JPY = rate.JPY      USD/BRL = rate.BRL
  //   USD/CHF = rate.CHF     USD/CAD = rate.CAD
  //   EUR/GBP = rate.GBP / rate.EUR   GBP/JPY = rate.JPY / rate.GBP
  try {
