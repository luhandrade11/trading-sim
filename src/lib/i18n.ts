...
const T: Record<Locale, Str> = {
  "pt-BR": {
    ...
    opening: "Abrindo operação…", insufficient: "Saldo insuficiente", min_amount: "Valor mínimo inválido",
    ...
    promo_title: "Promoções Ativas", promo_bonus: "100% de bônus no seu primeiro depósito",
    ...
    withdraw_min: "Mínimo R$50", withdraw_real_only: "Disponível apenas na conta real",
    win_result: "VITÓRIA!", loss_result: "PERDEU",
    reset_title: "Resetar conta demo",
    reset_msg: "Apaga todo o histórico e restaura seu saldo virtual ao valor inicial.",
    reset_btn: "Resetar tudo",
    deposit_title: "Conta Real", deposit_sub: "Opere com dinheiro real e saque seus lucros.",
    deposit_demo_note: "Você está usando saldo virtual. Deposite para ativar a conta real.",
